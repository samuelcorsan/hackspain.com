  ...
  return {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Los patrocinadores actuales son Google, K Fund, fal.ai, Exa, UPM, OneCoWork, Cursor, Exponential, HappyRobot, Mozart AI y Embat. Se esperan muchos más; la lista completa y actualizada siempre estará en hackspain.com/sponsors.",
        },
      },
      {
        "@type": "Question",
