...
function slot4Geometry(art: IllArt | null): Pick<IllDef, "x" | "y" | "w" | "h" | "clip"> {
...
function slot5Geometry(art: IllArt | null): Pick<IllDef, "x" | "y" | "w" | "h" | "clip"> {
  if (art === "code") {
...
function boxFor(slotIndex: number, art: IllArt | null): string {
  ...
  if (slotIndex === 4) return "items-center justify-center p-2";
  if (slotIndex === 5) return "items-end justify-center pb-2";
  if (slotIndex === 0) return "items-end justify-center";
  if (slotIndex === 1) return "items-center justify-center p-3";
  if (slotIndex === 2) return "items-end justify-center";
  return "items-end justify-center";
}

function delayFor(slotIndex: number, art: IllArt | null): number {
  if (slotIndex === 4 && (art === "spark" || art === "medal")) return 0.07;
  if (slotIndex === 5 && art === "code") return 0.05;
  if (slotIndex === 4) return 0.01;
  if (slotIndex === 5) return 0.06;
  if (slotIndex === 0) return 0.04;
  if (slotIndex === 1) return 0.05;
  if (slotIndex === 2) return 0.03;
  return 0.07;
}
...
function imgFor(slotIndex: number, art: IllArt | null): string {
  ...
  if (slotIndex === 1 && art === "quixote") return "h-[90%] w-auto max-h-[96%]";
  if (slotIndex === 1 && art === "compass") return "h-[92%] w-auto max-h-[96%]";
  ...
  if (slotIndex === 0) return "h-[94%] w-auto";
  if (slotIndex === 1) return "h-full w-auto";
  if (slotIndex === 2) return "w-full h-auto";
  if (slotIndex === 3) return "h-full w-auto max-w-[98%]";
  if (slotIndex === 4) return "h-[88%] w-auto max-w-[95%]";
...
export function illustrationsForSection(sectionIndex: number): IllDef[] {
  ...
  return SLOT_IDS.map((id, i) => {
    ...
    const fill =
      (i === 4 && (art === "spark" || art === "medal")) || (i === 5 && art === "code")
        ? ("none" as const)
        : undefined;
